...
const menu = {
   main: ["profile", "inventory", "shop", "grind", "heal", "-"],
...
export default {
   ...
   options: {
      ...
      owner: ["6285336525092"], // set owner number on here
      sessionName: "session", // for name session
      prefix: /^[°•π÷×¶∆£¢€¥®™+✓_=|/~!?@#%^&.©^]/i,
      pairingNumber: "62xxxx" // Example Input : 62xxx
   },
   ...
   Exif: {
      ...
      packPublish: "valent.",
      packEmail: "nuestracommunity@gmail.com",
      packWebsite: "https://valent.my.id",
